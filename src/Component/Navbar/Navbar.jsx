        ...
        <div className="row">
          <div className="container relative">
            <div className="col bg-[rgba(255,255,255,0.2)] lg:bg-transparent shadow-md lg:shadow-none flex justify-between items-center w-full px-3 py-4 fixed lg:absolute top-0 left-0 z-[99999999]">
              ...
              <div
                className={`navItem flex flex-col lg:flex-row items-start lg:items-center gap-y-[15vh] bg-[rgba(255,255,255,0.25)] lg:bg-[transparent] h-[100vh] lg:h-auto w-[40vw] min-w-[250px] lg:w-auto fixed top-0 ${
                  nav ? `right-0` : `-right-[100vh]`
                } px-8 lg:px-0 py-12 lg:py-0 shadow-2xl lg:shadow-none lg:static lg:gap-[2vw] xl:gap-[3vw] 2xl:gap-[4vw] 4k:gap-[6vw] transition-all ease-in duration-500`}
              >
                <ul className="flex flex-col lg:flex-row items-start lg:items-center gap-y-[5vh] pt-[10vh] lg:pt-0 lg:gap-[2vw] xl:gap-[3vw] 4k:gap-[4vw]">
                  <li>
                    <a
                      ...
                      offset={50}
                      duration={1000}
                      className=" text-black-2 text-[18px] font-sofia not-italic font-normal leading-normal capitalize hover:text-primary transition-all ease-linear duration-500 relative"
                    >
                      হোম
              ...
              {nav ? (
                <FaXmark
                  onClick={() => navHandler()}
                  size={40}
                  className="lg:hidden z-[999999999] text-[#3b1f1f]"
                />
              ) : (
                <FaBarsStaggered
                  onClick={() => navHandler()}
