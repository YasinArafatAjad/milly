                        ...
                        <div className="col flex flex-col items-center justify-center gap-8 overflow-x-auto">
                            ...
                            <table border={0} cellPadding={0} cellSpacing={0} className=' self-start meal_table text-center shadow-xl w-[80vw]'>
                                ...
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>28</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>5.5</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>22</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>41.5</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>32</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1'></td>                                    
                                    <td className='uppercase bold text-lg border-2 py-3 px-1 bg-slate-400'>22.5</td>
                                </tr>
                            </table>
                            {/* summury of May */}
                            <p className=" text-[#fcfdfd] flex gap-1 items-center"><FaCarrot />মোট মিলঃ ১৮০ টি ।</p>
