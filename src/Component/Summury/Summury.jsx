        ...
        <>
            <section id="summury" className="py-20 bg-[#e35959]">
                ...
                <div className="summury_May text-center text-lg text-[#1f2937]">
                    <p className="text-xl">বাজার খরচঃ <span className="BazarC">1490+5725</span> টাকা</p>
                    <p className="text-xl">মোট বাজার খরচঃ 7215 টাকা</p>
                    <p className="text-xl">বাড়তি খরচঃ 1950 টাকা</p>
                    <p className="text-xl">মোট মিলঃ 52+225.5 = 277.5
                    </p>
                    <br />
                    <p className="text-xl">মোট জমাঃ 10,000 টাকা</p>
                    <p className="text-xl">মোট খরচঃ 9,165 টাকা</p>
                    <br />
                    <p className="text-xl">হ্যান্ড-ক্যাশঃ 835 টাকা</p>
